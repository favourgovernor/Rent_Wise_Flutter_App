...
import 'package:rentwise_app/widgets/apartment_tabs_preview.dart';
...
class _HomeContentState extends State<HomeContent> {
  final List<String> tabs = ['Apartment 1', 'Apartment 2', 'Apartment 3'];
  int selectedIndex = 0;
  ...
  @override
  Widget build(BuildContext context) {
    final data = _tabData[selectedIndex];
